...
/**
 * Provides the local service interface for chucdanh. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Duy Nguyen
 * @see chucdanhLocalServiceUtil
...
public interface chucdanhLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link chucdanhLocalServiceUtil} to access the chucdanh local service. Add custom service methods to {@link com.test.service.impl.chucdanhLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
