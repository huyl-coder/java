...
import com.test.service.chucdanhLocalService;
...
/**
 * Provides the base implementation for the chucdanh local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.test.service.impl.chucdanhLocalServiceImpl}.
 * </p>
 *
 * @author Duy Nguyen
 ...
 * @generated
 */
public abstract class chucdanhLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements chucdanhLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.test.service.chucdanhLocalServiceUtil} to access the chucdanh local service.
	 */
	...
	@Override
	public chucdanh addchucdanh(chucdanh chucdanh) throws SystemException {
		chucdanh.setNew(true);

		return chucdanhPersistence.update(chucdanh);
	}
	 ...
	 */
	@Override
	public chucdanh createchucdanh(long id) {
		return chucdanhPersistence.create(id);
	}
	...
	@Override
	public chucdanh deletechucdanh(long id)
		throws PortalException, SystemException {
		return chucdanhPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public chucdanh deletechucdanh(chucdanh chucdanh) throws SystemException {
		return chucdanhPersistence.remove(chucdanh);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(chucdanh.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return chucdanhPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return chucdanhPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return chucdanhPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return chucdanhPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public chucdanh fetchchucdanh(long id) throws SystemException {
		return chucdanhPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public chucdanh getchucdanh(long id)
		throws PortalException, SystemException {
		return chucdanhPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return chucdanhPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<chucdanh> getchucdanhs(int start, int end)
		throws SystemException {
		return chucdanhPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getchucdanhsCount() throws SystemException {
		return chucdanhPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public chucdanh updatechucdanh(chucdanh chucdanh) throws SystemException {
		return chucdanhPersistence.update(chucdanh);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.test.model.chucdanh",
			chucdanhLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.test.model.chucdanh");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = chucdanhPersistence.getDataSource();
	...
	private chucdanhLocalServiceClpInvoker _clpInvoker = new chucdanhLocalServiceClpInvoker();
}