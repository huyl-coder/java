...
import com.test.service.nhomLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.test.service.impl.nhomLocalServiceImpl}.
 * </p>
 *
 * @author Duy Nguyen
 ...
 * @generated
 */
public abstract class nhomLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements nhomLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.test.service.nhomLocalServiceUtil} to access the nhom local service.
	 */
	...
	@Override
	public nhom addnhom(nhom nhom) throws SystemException {
		nhom.setNew(true);
	...
	@Override
	public nhom deletenhom(long id) throws PortalException, SystemException {
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public nhom deletenhom(nhom nhom) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(nhom.class,
	...
	@Override
	public nhom fetchnhom(long id) throws SystemException {
	 ...
	 */
	@Override
	public nhom getnhom(long id) throws PortalException, SystemException {
	 ...
	 */
	@Override
	public List<nhom> getnhoms(int start, int end) throws SystemException {
	 ...
	 */
	@Override
	public int getnhomsCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public nhom updatenhom(nhom nhom) throws SystemException {
		return nhomPersistence.update(nhom);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.test.model.nhom",
			nhomLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister("com.test.model.nhom");
	}
	...
	private nhomLocalServiceClpInvoker _clpInvoker = new nhomLocalServiceClpInvoker();
}