<%@page import="com.test.model.loaivanban"%>
...
<form name=frm method=post action="<%=saveURL %>">
	<input type=hidden name="<portlet:namespace/>id" value="<%=loaiVanBan.getId()%>">
	<table>
		<tr>
			<td>Tên:</td>
			<td><input type=text name="<portlet:namespace/>ten" value="<%=loaiVanBan.getTen()%>"></td>
		</tr>
		<tr>
