<%@page import="com.test.model.phongban"%>
...
<form name=frm method=post action="<%=saveURL %>">
	<input type=hidden name="<portlet:namespace/>id" value="<%=phongBan.getId()%>">
	<table>
		<tr>
			<td>Tên:</td>
			<td><input type=text name="<portlet:namespace/>ten" value="<%=phongBan.getTen()%>"></td>
		</tr>
		<tr>
