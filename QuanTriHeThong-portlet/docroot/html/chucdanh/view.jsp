...
<%
List<chucdanh> data = (List<chucdanh>)request.getAttribute("data");
	...
	<table>
		<tr>
			<td>
				...
				Mã:<input type= text value="" name="<portlet:namespace/>ma">
...
<liferay-ui:search-container iteratorURL="<%=interatorURL%>" delta="<%=delta%>" 
	...
	<liferay-ui:search-container-row className="com.test.model.chucdanh"
		...
		<liferay-ui:search-container-column-text name="Mã Chức Danh">
			<%=item.getMa()%>
		</liferay-ui:search-container-column-text>
