...
import ispace.service.KieuVanBanLocalService;
...
/**
 * Provides the base implementation for the kieu van ban local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ispace.service.impl.KieuVanBanLocalServiceImpl}.
 * </p>
 *
 * @author PC
 ...
 * @generated
 */
public abstract class KieuVanBanLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements KieuVanBanLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link ispace.service.KieuVanBanLocalServiceUtil} to access the kieu van ban local service.
	 */
	...
	@Override
	public KieuVanBan addKieuVanBan(KieuVanBan kieuVanBan)
		throws SystemException {
		kieuVanBan.setNew(true);

		return kieuVanBanPersistence.update(kieuVanBan);
	}
	 ...
	 */
	@Override
	public KieuVanBan createKieuVanBan(long id) {
		return kieuVanBanPersistence.create(id);
	}
	...
	@Override
	public KieuVanBan deleteKieuVanBan(long id)
		throws PortalException, SystemException {
		return kieuVanBanPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public KieuVanBan deleteKieuVanBan(KieuVanBan kieuVanBan)
		throws SystemException {
		return kieuVanBanPersistence.remove(kieuVanBan);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(KieuVanBan.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return kieuVanBanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return kieuVanBanPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return kieuVanBanPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public KieuVanBan fetchKieuVanBan(long id) throws SystemException {
		return kieuVanBanPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public KieuVanBan getKieuVanBan(long id)
		throws PortalException, SystemException {
		return kieuVanBanPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return kieuVanBanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<KieuVanBan> getKieuVanBans(int start, int end)
		throws SystemException {
		return kieuVanBanPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getKieuVanBansCount() throws SystemException {
		return kieuVanBanPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public KieuVanBan updateKieuVanBan(KieuVanBan kieuVanBan)
		throws SystemException {
		return kieuVanBanPersistence.update(kieuVanBan);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("ispace.model.KieuVanBan",
			kieuVanBanLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = kieuVanBanPersistence.getDataSource();
	...
	private KieuVanBanLocalServiceClpInvoker _clpInvoker = new KieuVanBanLocalServiceClpInvoker();
}