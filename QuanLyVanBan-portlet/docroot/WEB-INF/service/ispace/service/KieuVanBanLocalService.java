...
/**
 * Provides the local service interface for KieuVanBan. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author PC
 * @see KieuVanBanLocalServiceUtil
...
public interface KieuVanBanLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link KieuVanBanLocalServiceUtil} to access the kieu van ban local service. Add custom service methods to {@link ispace.service.impl.KieuVanBanLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
